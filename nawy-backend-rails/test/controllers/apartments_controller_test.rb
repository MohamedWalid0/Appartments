...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { floor_number: @apartment.floor_number, name: @apartment.name, number_of_rooms: @apartment.number_of_rooms } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { floor_number: @apartment.floor_number, name: @apartment.name, number_of_rooms: @apartment.number_of_rooms } }
